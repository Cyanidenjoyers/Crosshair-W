...
int main(int argc, char **argv) {
    ...
    widgets.size_scale = gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 1, 50, 0.1);
    gtk_scale_set_digits(GTK_SCALE(widgets.size_scale), 1);
    ...
    widgets.size_spin = gtk_spin_button_new_with_range(1, 50, 0.1);
    gtk_spin_button_set_digits(GTK_SPIN_BUTTON(widgets.size_spin), 1);
    ...
    widgets.offset_x_scale = gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, -50, 50, 0.1);
    gtk_scale_set_digits(GTK_SCALE(widgets.offset_x_scale), 1);
    ...
    widgets.offset_x_spin = gtk_spin_button_new_with_range(-50, 50, 0.1);
    gtk_spin_button_set_digits(GTK_SPIN_BUTTON(widgets.offset_x_spin), 1);
    ...
    widgets.offset_y_scale = gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, -50, 50, 0.1);
    gtk_scale_set_digits(GTK_SCALE(widgets.offset_y_scale), 1);
    ...
    widgets.offset_y_spin = gtk_spin_button_new_with_range(-50, 50, 0.1);
    gtk_spin_button_set_digits(GTK_SPIN_BUTTON(widgets.offset_y_spin), 1);
    ...
    widgets.thickness_scale = gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 1, 10, 0.1);
    gtk_scale_set_digits(GTK_SCALE(widgets.thickness_scale), 1);
    ...
    widgets.thickness_spin = gtk_spin_button_new_with_range(1, 10, 0.1);
    gtk_spin_button_set_digits(GTK_SPIN_BUTTON(widgets.thickness_spin), 1);
    ...
    widgets.gap_scale = gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 0, 30, 0.1);
    gtk_scale_set_digits(GTK_SCALE(widgets.gap_scale), 1);
    ...
    widgets.gap_spin = gtk_spin_button_new_with_range(0, 30, 0.1);
    gtk_spin_button_set_digits(GTK_SPIN_BUTTON(widgets.gap_spin), 1);
